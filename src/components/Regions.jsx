...
function Regions() {
  return (
    <>
      ...
      <section
        id="regions"
        className="md:py-24 lg:py-0 bg-offwhite lg:min-h-screen flex flex-col md:flex-row items-center justify-center w-full max-w-screen-2xl mx-auto md:gap-12"
      >
        <div className="w-full md:w-2/5 2xl:rounded-l-3xl rounded-r-3xl md:bg-neutral-200 flex flex-col items-center">
          {descRegions}
        </div>

        <div className="relative w-full md:w-3/5 2xl:rounded-r-3xl md:rounded-l-3xl md:rounded-r-none md:bg-neutral-200 overflow-hidden">
